...
subtitle: |
  Prequisites for Day 3 & Day 4 
  Summer School Open Stack - GISE Hub, IIT Bombay
  27th - 28th, July 2024
format:
    pdf: default
    html: 
...
![](/images/GIS4Epi-logo.png){width="50%"}
:::

::: column-page-right
::: justify

**Congratulations!** on being accepted to the **Spatial Data Science for Public Health** Workshop! We are thrilled to welcome you on board and hope that you are excited to take on this exciting journey.
...
::: column-page-inset
![Screenshot of RStudio IDE](/images/rstudio_ide.png){fig-align="center" width="100%"}
:::
...
![](/images/hex-tidyverse.png){width="100"}
:::
:::

![Installing the `tidyverse` package](/images/tidyverse_install_1.png){fig-align="center" width="100%"}
...
![Output of calling the `tidyverse` package into the R Environment](/images/tidyverse_load_1.png){fig-align="center" width="90%"}
...
[**Congratulations** for making through the first step of your journey. **Now, the learning begins...**]{style="color:blue;"}
